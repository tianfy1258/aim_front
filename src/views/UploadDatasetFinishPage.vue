<template>
  <div>
    <div style="display: flex;justify-content: center;align-items: center;">
      ...
      <div style="margin-right: 80px;margin-top: 80px;">
        <svg t="1651831675606" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
             p-id="2260" width="20" height="20">
          <path
          ...
          <path
              ...
              p-id="2262" fill="#42843b"></path>
        </svg>
        <div class="flex-container">
          <div class="description">创建成功，将在{{ countdown }}秒后跳转至</div>
          <el-button type="primary" link @click="jumpPage" style="font-size:1.5em; margin: 0;padding: 0;">数据集查看界面
          </el-button>
